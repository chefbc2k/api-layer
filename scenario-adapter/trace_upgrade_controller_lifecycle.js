...
async function main() {
  ...
  if (network.chainId !== 31337n) {
    throw new Error("trace_upgrade_controller_lifecycle is local-only on 31337; it uses mnemonic-derived local signers and advanceTime and cannot prove Base Sepolia parity yet");
  }
