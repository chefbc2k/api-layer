...
async function main() {
  ...
  if (network.chainId !== 31337n) {
    throw new Error("trace_staking_negative_paths is local-only on 31337; it uses evm_increaseTime/evm_mine and cannot prove Base Sepolia workflow parity yet");
  }
