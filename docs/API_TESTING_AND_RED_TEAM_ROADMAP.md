...
### Event And Indexer Projection Run — 2026-08-18
...
- Add deterministic fixtures and persisted receipt evidence for the remaining `211` write methods before claiming every write path is proven end to end.
