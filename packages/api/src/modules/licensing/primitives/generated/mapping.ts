...
export const licensingMethodDefinitions: HttpMethodDefinition[] = [
  {
    ...
    "signature": "createLicense(address,bytes32,tuple)",
    "category": "write",
  ...
  {
    "key": "VoiceLicenseFacet.facetFunctionSelectors",
    "facetName": "VoiceLicenseFacet",
    ...
    "httpMethod": "POST",
    "path": "/v1/licensing/queries/facet-function-selectors",
    "inputShape": {
      "kind": "none",
      "bindings": []
    },
    ...
    "rateLimitKind": "read",
    "supportsGasless": false,
    "notes": "VoiceLicenseFacet.facetFunctionSelectors",
    "methodName": "facetFunctionSelectors",
    "signature": "facetFunctionSelectors()",
    "category": "read",
    "mutability": "pure",
    "liveRequired": false,
    "cacheClass": "short",
  ...
  },
  {
    ...
    "rateLimitKind": "read",
    "supportsGasless": false,
    "notes": "VoiceLicenseFacet.getLicenseTerms; caller-scoped read that resolves the active license for _msgSender()",
  ...
  },
  {
    ...
    "rateLimitKind": "write",
    "supportsGasless": false,
    "notes": "VoiceLicenseFacet.issueLicense; starts the active license lifecycle for a licensee using template or derived voice-specific terms",
  ...
  {
    "key": "VoiceLicenseFacet.recordUsage",
    "facetName": "VoiceLicenseFacet",
    ...
    "classification": "action",
    "httpMethod": "POST",
    "path": "/v1/licensing/commands/record-usage",
    "inputShape": {
      "kind": "body",
      "bindings": [
        {
    ...
    "rateLimitKind": "write",
    "supportsGasless": false,
    "notes": "VoiceLicenseFacet.recordUsage",
  ...
  },
  {
    ...
    "rateLimitKind": "write",
    "supportsGasless": false,
    "notes": "VoiceLicenseFacet.transferLicense; caller-scoped action that must be executed by the active licensee using the stored license templateHash",
  ...
  },
  {
    ...
    "rateLimitKind": "write",
    "supportsGasless": false,
    "notes": "VoiceLicenseTemplateFacet.createLicenseFromTemplate; derives and stores voice-specific template terms only, it does not issue an active license",
    "methodName": "createLicenseFromTemplate",
    "signature": "createLicenseFromTemplate(bytes32,bytes32,tuple)",
    "category": "write",
    "mutability": "nonpayable",
    "liveRequired": false,
    "cacheClass": "none",
  ...
  },
  {
    ...
    "signature": "createTemplate(tuple)",
    "category": "write",
    "mutability": "nonpayable",
    "liveRequired": false,
    "cacheClass": "none",
  ...
  {
    "key": "VoiceLicenseTemplateFacet.getSelectors",
    "facetName": "VoiceLicenseTemplateFacet",
    ...
    "classification": "query",
    "httpMethod": "POST",
    "path": "/v1/licensing/queries/get-selectors",
    "inputShape": {
      "kind": "none",
      "bindings": []
    },
    ...
    "rateLimitKind": "read",
    "supportsGasless": false,
    "notes": "VoiceLicenseTemplateFacet.getSelectors",
  ...
  },
  {
    ...
    "signature": "updateTemplate(bytes32,tuple)",
    "category": "write",
    "mutability": "nonpayable",
    "liveRequired": false,
    "cacheClass": "none",
