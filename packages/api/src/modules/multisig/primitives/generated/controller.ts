...
export function createMultisigPrimitiveController(context: ApiExecutionContext): Record<string, import("express").RequestHandler> {
  ...
  return {
    ...
    getOperation: createMethodRequestHandler(multisigMethodDefinitions.find((definition) => definition.operationId === "getOperation")!, getOperationRequestSchemas, service.getOperation),
    ...
    setOperationConfig: createMethodRequestHandler(multisigMethodDefinitions.find((definition) => definition.operationId === "setOperationConfig")!, setOperationConfigRequestSchemas, service.setOperationConfig),
