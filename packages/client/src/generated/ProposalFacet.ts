...
export function createProposalFacetWrapper(context: FacetWrapperContext) {
  return {
    ...
    getActiveProposals: (...args: unknown[]) => invokeRead(context, "ProposalFacet", "getActiveProposals", args, false, 5),
    getProposalTypeConfig: (...args: unknown[]) => invokeRead(context, "ProposalFacet", "getProposalTypeConfig", args, false, 30),
    getProposerProposals: (...args: unknown[]) => invokeRead(context, "ProposalFacet", "getProposerProposals", args, false, 5),
