...
export function createTokenSupplyFacetWrapper(context: FacetWrapperContext) {
  return {
    ...
    name: (...args: unknown[]) => invokeRead(context, "TokenSupplyFacet", "name", args, false, 600),
    ...
    symbol: (...args: unknown[]) => invokeRead(context, "TokenSupplyFacet", "symbol", args, false, 600),
