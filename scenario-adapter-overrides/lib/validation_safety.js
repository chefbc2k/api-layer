...
const AUTHORITATIVE_BASELINE_REPORT =
  process.env.API_LAYER_VALIDATION_BASELINE_REPORT_PATH ||
  "artifacts/release-readiness/testnet-validation-report-2026-03-10-rerun.md";
